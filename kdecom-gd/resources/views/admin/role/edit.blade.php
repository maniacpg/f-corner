...
@endsection
@section('js')
    <script src="{{asset('admins/role/edit/edit.js')}}"></script>
@endsection
@section('content')

    <div class="content-wrapper">

        @include('partials.content-header', ['name'=>'Vai trò','key'=>'Sửa vai trò'])

        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <form id="categoryForm" action="{{ route('roles.update', ['id' => $role->id]) }}" method="post" enctype="multipart/form-data" style="width: 100%">
                        <div class="col-md-12">
                            @csrf
                            ...
                            <div class="form-group">
                                <label>Mô tả</label>
                                <input type="text" value="{{ $role->display_name }}" name="display_name" class="form-control" placeholder="Nhập mô tả">
                            </div>
                                                        ...
                                                        <h5 class="card-title">
                                                            <label>
                                                                <input type="checkbox"
                                                                       ...
                                                                       {{ $permissionChecked->contains('id', $permissionsChildItem->id) ? 'checked' : '' }}
                                                                       name="permission_id[]"
